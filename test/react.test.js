...
describe('Knockout Test:', () => {
    ...
    it('No Knockout in package.json', (done) => {
        
        assert.noFileContent(packageJson, /knockout/);

        done();
    })

    it('React in package.json', (done) => {
        
        assert.fileContent(packageJson, /react/);
